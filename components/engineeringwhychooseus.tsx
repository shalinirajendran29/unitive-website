...
const cards = [
  {
    ...
    points: [
      "Advanced Design & Engineering Expertise",
      " Precision-Driven Development Process",
      "Industry-Compliant Engineering Standards Execution Plan",
    ],
  },
  {
    id: "02",
    ...
    points: [
      "Concept-to-Prototype Solutions",
      "Simulation-Driven Design Validation",
      "Optimized Performance & Manufacturability",
    ],
  },
  {
    id: "03",
    ...
    title: "Reliable Execution",
      ...
      "Long-Term Engineering Support & Collaboration",
    ],
  },
];
 ...
 <div className="absolute top-10 right-0 opacity-20">
  ...
  Why Choose Us
          ...
          <p className="mx-auto mt-4 max-w-2xl text-[#494141]">
            Delivering innovative solutions, exceptional quality, and measurable business value.
          </p>
        </div>
