...
const cards = [
  ...
  },
  {
    ...
    points: [
      ...
      "Preliminary BoM Generation",
      "Detailed Roadmap Formulation",
    ],
  },
  {
    id: "03",
    icon:"/images/whychooseusicon.png",
    title: "Detail Design & Analysis",
      points: [
      "High-Fidelity Simulation",
      "Assembly Drafting & Final BoM",
      "Prototype Blueprinting",
    ],
  },
];
 ...
 <div className="absolute top-10 right-0 opacity-20">
  ...
  The Engineering Lifecycle
          ...
          <p className="mx-auto mt-4 max-w-2xl text-[#494141]">
           A proven, systematic approach to product development—from initial concept
           to final manufacturing validation
          </p>
        </div>
