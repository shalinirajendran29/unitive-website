...
const solutions = ["Web App Development", "Artificial Intelligence", "Internet Of Things"];
  ...
  return (
    <section className="w-full bg-white py-16 px-4 sm:px-8 lg:px-16">
      ...
      <div className="text-center max-w-3xl mx-auto mb-12">
        <h2 className="inline-block text-3xl sm:text-3xl md:text-4xl font-bold mb-2 bg-gradient-to-r from-[#FE5800] to-[#3B3B3B] bg-clip-text text-transparent">
      Need Expert Digital Support
      </h2>

        <p className="text-gray-500 mt-4 text-sm sm:text-base">
          Collaborate with our digital team for reliable solutions,
